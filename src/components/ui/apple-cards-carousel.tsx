        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            >
              ...
              <motion.p
                layoutId={layout ? `subtitle-${card.title}` : undefined}
                className="text-base font-medium text-black italic"
              >
                {card.subtitle}
              </motion.p>
              <motion.p
              ...
              <div className="py-10">
                ...
                />
                <p className="text-neutral-600  text-base md:text-2xl font-sans mx-auto mt-6">
      ...
      >
        ...
        <div className="relative z-40 p-8">
          <motion.p
            ...
            className="text-white text-sm md:text-base font-medium font-sans text-left italic"
          >
            {card.subtitle}
          </motion.p>
          <motion.p
